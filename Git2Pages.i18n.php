<?php
/**
 * Internationalisation file for extension Git2Pages
 *
 * @file
 * @ingroup Extensions
 */
 ...
 */
$messages['fr'] = array(
	'git2pages-desc' => 'Ajoute la fonction de l’analyseur <code><nowiki>{{#snippet:}}</nowiki></code> pour ajouter du contenu depuis un dépôt GIT dans les pages',
);
 ...
 */
$messages['lb'] = array(
	'git2pages-desc' => "Setzt d'Parserfonctioun <code><nowiki>{{#snippet:}}</nowiki></code> derbäi fir Inhalt aus engem GIT-Repository a Säiten ze setzen",
);
 ...
 */
$messages['ne'] = array(
	'git2pages-desc' => 'यसले पृष्ठमा गीट रिपोजिटरीबाट पार्सर अनुप्रयोग <code><nowiki>{{#snippet:}}</nowiki></code> थप्ने छ।',
);
 ...
 */
$messages['uk'] = array(
	'git2pages-desc' => 'Додає функцію парсеру <code><nowiki>{{#snippet:}}</nowiki></code> для додання вмісту із git-репозиторію у сторінки',
);
